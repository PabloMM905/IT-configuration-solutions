 ...
 * @author HP
 */
public class RegistrarNuevaVacuna extends javax.swing.JPanel {

    /**
     * Creates new form Inicio_PersonalSalud
     */
    public RegistrarNuevaVacuna() {
        initComponents();
        initStyle();
    ...
    private void initComponents() {
        ...
        txtLote.setForeground(new java.awt.Color(204, 204, 204));
        ...
        txtEnfermedad.setForeground(new java.awt.Color(204, 204, 204));
        ...
        txtDosis.setForeground(new java.awt.Color(204, 204, 204));
        ...
        txtFechaCad.setForeground(new java.awt.Color(204, 204, 204));
        txtFechaCad.setText("Fecha de caducidad");
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnConfirmarActionPerformed
        // TODO add your handling code here:
        if (!txtKit.getText().equals("Digite el kit de la vacuna")) {
            if (!txtLote.getText().equals("Digite el lote de la vacuna")) {
                if (!txtEnfermedad.getText().equals("Digite la enfermedad de la vacuna")) {
                    if (!txtDosis.getText().equals("Digite la dosis de la vacuna")) {

                        if (!txtFechaCad.getText().equals("Fecha de nacimeinto")) {
                            ConexionVacunasDisponibles nuevaVac = new ConexionVacunasDisponibles();
                            nuevaVac.registrarVacunaDisponible(txtKit, txtLote, txtEnfermedad, txtDosis, txtFechaCad);
                        } else {
